...
function App() {
  ...
  const [noData, setNoData] = useState(
    "Pesquise a cidade ou país que deseja saber o clima"
  );
  ...
  const getWeather = async (location) => {
    ...
    try {
      ...
      if (data.cod != 200) {
        setNoData("Localização não encontrada, tente novamente.");
        return;
      }
      setWeatherData(data);
  ...
  return (
    <div className="
      ...
      py-10"
    >
      <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-blue-900">
        {/* form card section  */}
        <div className="form-container">
          <div className="flex items-center justify-center">
            <h3
              className="my-auto mr-auto text-xl text-blue-600 font-bold shadow-md py-1 px-3 
            rounded-md bg-white bg-opacity-30"
            >
              ClimaTech
            </h3>
            <div className="flex p-2 text-blue-900 bg-white bg-opacity-60 rounded-lg">
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <h1 className="text-white text-2xl">
              A única previsão do tempo que você precisa
            </h1>
            <hr className="h-1 bg-white w-3/4 rounded-full my-5" />
            <form
              noValidate
            ...
            >
              <input
                ...
                className="relative rounded-xl py-3 px-3 w-2/3 bg-gray-300 bg-opacity-60 text-white placeholder-gray-200"
        ...
        <div className="w-2/4 p-5">
          <div className="flex flex-col my-10">
            ...
            {weatherData.length === 0 ? (
              ...
              <>
                <h1 className="text-5xl text-white mt-auto mb-4">Hoje</h1>
                <DetailCard weather_icon={weatherIcon} data={weatherData} />
                <h1 className="text-3xl text-white mb-4 mt-10">
                  Mais sobre {city}
                </h1>
